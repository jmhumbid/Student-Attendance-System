...
<head>
    ...
    <style>
        ...
        .sidebar-link.active, .sidebar-link:hover { background-color: #e0e7ff; color: #3b82f6; }
        .class-card {
...
<body class="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-blue-100 via-purple-100 to-pink-100">

    <!-- Sidebar - Uniform with Profile Page -->
    <div class="sidebar bg-gray-800 text-gray-100 p-4 md:p-6 flex flex-col w-full md:w-60 lg:w-64">
        <div class="flex items-center mb-6 md:mb-8">
            <img src="<?php echo htmlspecialchars($profile_img_url); ?>" alt="Instructor Icon" class="w-8 h-8 md:w-10 md:h-10 rounded-full mr-2 md:mr-3">
            <span class="text-lg md:text-xl font-semibold text-white"><?php echo htmlspecialchars($first_name); ?></span>
        </div>
        <nav class="flex flex-col space-y-2 md:space-y-4">
            <a href="instructor_dashboard.php" class="sidebar-link flex items-center py-2 px-3 md:px-4 rounded transition duration-200 bg-purple-700 text-white">
                <i class="fas fa-home mr-2 md:mr-3"></i> Dashboard
            </a>
            <a href="#" class="sidebar-link flex items-center py-2 px-3 md:px-4 rounded transition duration-200 text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-500 hover:shadow-lg">
                <i class="fas fa-chalkboard-teacher mr-2 md:mr-3"></i> Classes
            </a>
            <a href="attendance_scanner.php" class="sidebar-link flex items-center py-2 px-3 md:px-4 rounded transition duration-200 text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-500 hover:shadow-lg">
                <i class="fas fa-qrcode mr-2 md:mr-3"></i> Attendance Scanner
            </a>
            <a href="instructor_profile.php" class="sidebar-link flex items-center py-2 px-3 md:px-4 rounded transition duration-200 text-gray-300 hover:text-white hover:bg-gradient-to-r hover:from-green-400 hover:to-blue-500 hover:shadow-lg">
                <i class="fas fa-user-circle mr-2 md:mr-3"></i> Profile
            </a>
            <!-- Settings Section -->
            <div class="mt-2 md:mt-4">
                ...
                <div id="settingsDropdown" class="hidden pl-4 md:pl-8 mt-2 space-y-2">
                    <button id="privacyBtn" class="sidebar-link w-full text-left">
                        <i class="fas fa-shield-alt"></i> Privacy and Security
                    </button>
                    <div id="privacyDropdown" class="hidden pl-4 md:pl-8 mt-2 space-y-2">
        ...
        <div class="mt-auto">
            <a href="instructor_logout.php" id="instructorLogoutLink" class="flex items-center py-2 px-3 md:px-4 rounded transition duration-200 text-red-400 hover:text-red-600 hover:bg-gray-700">
                <i class="fas fa-sign-out-alt mr-2 md:mr-3"></i> Logout
            </a>
        </div>
    </div>

    <!-- Main Content -->
    <div class="main-content flex-1 p-4 md:p-8 flex flex-col gap-4 md:gap-8">
        <!-- Welcome Banner -->
